...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        rate = 2
        self.bn1 = nn.BatchNorm2d(inplanes)
        self.conv1 = nn.Conv2d(inplanes, planes*rate, kernel_size=1, bias=False)
        self.bn2 = nn.BatchNorm2d(planes * rate)
        self.conv2 = nn.Conv2d(planes * rate, (planes * rate),
                               kernel_size=5,
                               stride=stride,
                               padding=2,
                               bias=False,
                               groups=planes * rate)
        self.bn3 = nn.BatchNorm2d((planes * rate))
        self.conv3 = nn.Conv2d((planes * rate),
